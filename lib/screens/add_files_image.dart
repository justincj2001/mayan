...
class AddFilesImageScreen extends StatefulWidget {
  var data;
  var index;
  AddFilesImageScreen({super.key,this.data,this.index,});

  @override
  State<AddFilesImageScreen> createState() => _AddFilesImageScreenState();
}

class _AddFilesImageScreenState extends State<AddFilesImageScreen> {
